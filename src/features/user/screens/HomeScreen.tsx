...
import { getAllServices } from "../../../core/services/mock/mockData";
...
import { BORDER_RADIUS, COLORS, FONT_SIZE, FONT_WEIGHT, SERVICE_CATEGORIES, SHADOWS, SPACING } from "../../../shared/constants/constants";
...
export default function HomeScreen({ navigation }: any) {
  ...
  const [selectedLocation, setSelectedLocation] = useState<{ state: string; city: string } | null>(null);
  ...
  useEffect(() => {
    ...
    if (selectedLocation) {
      filtered = filtered.filter((s) => {
        // Must match state
        if (s.state !== selectedLocation.state) return false;

        // If City is selected, must match City
        // If City is empty, show all cities in the state
        ...
        {selectedLocation && (
          <View style={styles.locationBadge}>
            <Text style={styles.locationBadgeText}>
              📍 {selectedLocation.city ? `${selectedLocation.city}, ${selectedLocation.state}` : `All of ${selectedLocation.state}`}
            </Text>
          </View>
        )}
      </View>
