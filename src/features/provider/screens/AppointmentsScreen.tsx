...
import { getBookingsForProvider, rescheduleBooking, updateBookingStatus } from "../../../core/services/mock/mockData";
                        ...
                        {selectedBooking && (
                            <ScrollView style={styles.modalBody}>
                                <View style={styles.modalSection}>
                                    ...
                                    {selectedBooking.city && selectedBooking.lga && selectedBooking.state && (
                                        <Text style={styles.modalDetailSecondary}>
                                            {selectedBooking.city}, {selectedBooking.lga}, {selectedBooking.state}
                                        </Text>
                                    )}
...
const styles = StyleSheet.create({
    ...
    modalBody: {
        padding: SPACING.xl,
        paddingBottom: SPACING.xxxl + 20, // Extra padding for Android navigation bar
    },
    ...
    modalActions: {
        gap: SPACING.md,
        paddingBottom: SPACING.xxl, // Extra padding for Android navigation bar
    },
    ...
    rescheduleButton: {
        backgroundColor: '#3b82f6', // Brighter blue for better visibility
    },
    ...
    rescheduleActions: {
        ...
        marginBottom: SPACING.xl, // Extra padding for Android navigation bar
    },
